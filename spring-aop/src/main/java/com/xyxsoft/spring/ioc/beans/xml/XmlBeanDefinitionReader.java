package com.xyxsoft.spring.ioc.beans.xml;
...
import com.xyxsoft.spring.ioc.beans.AbstractBeanDefinitionReader;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader{
	...
	public void loadBeanDefinitions(String location) throws Exception {
		InputStream inputStream=(InputStream) getResourceLoader().getResource(location).getInputStream();
